...
export default defineContentScript({
  ...
  main(ctx) {
    ...
    console.log(cleanHTMLContent.length)

    // Send the clean content to background script (convert to JSON string)
    extensionMessenger.sendMessage('activate', cleanHTMLContent);
  }
});
